...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .requestMatchers("/books/id/**").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/books/all").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/books/author/**").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/books/{authorName}/{bookName}").hasAnyAuthority("ADMIN", "USER")
